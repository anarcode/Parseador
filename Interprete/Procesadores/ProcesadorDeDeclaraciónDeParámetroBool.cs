namespace Interprete.Procesadores
{
    ...
    public class ProcesadorDeDeclaraciónDeParámetroBool : ProcesadorDeDeclaraciónDeBool
    {
        public ProcesadorDeDeclaraciónDeParámetroBool(ILenguaje lenguaje, IRepositorioDeProcesadores repositorio)
